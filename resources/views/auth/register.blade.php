...
<section id="wrapper">
    <div class="login-register" style="background-image:url({{asset('assets/admin/')}}/images/background/lbg.jpg);">
        <div class="login-box card" style="margin-top: -50px">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{route('custom.register')}}" method="post">
                    @csrf
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="col-xs-12">
                                <input class="form-control @error('first_name') is-invalid @enderror" type="text" name="first_name" required="" placeholder="First Name"> </div>
                            @error('first_name')
                        ...
                        <div class="form-group col-md-6">
                            <div class="col-xs-12">
                                <input class="form-control @error('last_name') is-invalid @enderror" type="text" name="last_name" required="" placeholder="Last name"> </div>
                            @error('last_name')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group col-md-6">
                            <div class="col-xs-12">
                                <input class="form-control @error('user_name') is-invalid @enderror" type="text" name="user_name" required="" placeholder="User name"> </div>
                            @error('user_name')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group col-md-6">
                            <div class="col-xs-12">
                                <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" required="" placeholder="Email"> </div>
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group col-md-6">
                            <div class="col-xs-12">
                                <input class="form-control @error('password') is-invalid @enderror" type="password" name="password" required="" placeholder="Password"> </div>
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group text-center">
                        <div class="col-xs-12 p-b-20">
                            <button class="btn btn-block btn-lg btn-success btn-rounded" type="submit">Sign In</button>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            Don't have an account? <a href="{{route('login')}}" class="text-info m-l-5"><b>Sign In</b></a>
                        </div>
                    </div>
                </form>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                        <div class="social">
                            <a href="{{ url('/auth/redirect/google') }}">
                                ...
                                <button class="btn  btn-googleplus" data-toggle="tooltip" title="Login with Facebook"> <i class="fab fa-google-plus-g"></i> </button>
                            </a>
                            <a href="{{ url('/auth/redirect/facebook') }}">
                                <button class="btn btn-facebook" data-toggle="tooltip" title="Login with Google"> <i class="fab fa-facebook-f"></i> </button>
                            </a>
                        </div>
                    </div>
                </div>
