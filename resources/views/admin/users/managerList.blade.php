                        ...
                        <table id="example23"
                            ...
                            @foreach($manager as $pro)
                                ...
                                <div class="modal fade" id="adminedit{{$pro->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <form action="{{route('admin.manager.details.update')}}" method="post">
                                        @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="hidden" name="admin_edit_id" value="{{$pro->id}}" class="form-control admineditid">
