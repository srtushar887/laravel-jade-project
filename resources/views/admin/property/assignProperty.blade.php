    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.save.assign.property')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="date" id="firstName" name="message" class="form-control" placeholder="Enter Site Title"></textarea>
                                            <small class="form-control-feedback">  </small> </div>
                                    </div>
