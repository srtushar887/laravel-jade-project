...
@section('manager')
    ...
    <div class="modal fade" id="manager-close-request" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
@section('js')
    ...
    <script>
        ...
        function managercloserequest(id) {
            $('.requestid').val(id);
        }
        ...
        $(document).ready(function () {
            ...
            $('#itemtable').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('get.manager.close.request') }}",
                columns: [
