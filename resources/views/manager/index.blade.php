                    ...
                    <div class="col-md-12 col-lg-6 col-sm-12">
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    @if(count($payments) > 0)
                                        @foreach($payments as $payment)
                                            <tr>
                                                <td class="txt-oflo">{{$payment->tanant->first_name}} {{$payment->tanant->first_name}}</td>
                                ...
                                <span class="label-megna label-rounded"><a href="{{route('manager.transaction')}}">Check all payments.</a> </span>
                            </div>
                        </div>
