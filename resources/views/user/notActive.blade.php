...
<section id="wrapper">
    <div class="login-register" style="background-image:url({{asset('assets/admin/')}}/images/background/lbg.jpg);">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{route('customlogin')}}" method="post">
                    @csrf
                    <img src="http://188.166.68.54/assets/admin/images/logo/jaditecp.png" class="rounded mx-auto d-block" alt="Login Logo">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                        <div class="social">
                            <a href="{{ url('/auth/redirect/google') }}">
                                ...
                                <button class="btn  btn-googleplus" data-toggle="tooltip" title="Login with Google"> <i class="fab fa-google-plus-g"></i> </button>
                            </a>
                            <a href="{{ url('/auth/redirect/facebook') }}">
                                <button class="btn btn-facebook" data-toggle="tooltip" title="Login with Facebook"> <i class="fab fa-facebook-f"></i> </button>
                            </a>
                        </div>
                    </div>
                </div>
